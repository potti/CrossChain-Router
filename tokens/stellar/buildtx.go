...
func (b *Bridge) BuildRawTransaction(args *tokens.BuildTxArgs) (rawTx interface{}, err error) {
	...
	if asset.IsNative() {
		...
		err = b.checkNonNativeBalance(asset.GetCode(), asset.GetIssuer(), args.From, amt)
		if err != nil {
			return nil, err
		}
	}
	...
	return NewUnsignedPaymentTransaction(fromAccount, b.NetworkStr, receiver, amt.String(), fee, memo)
}
...
func NewUnsignedPaymentTransaction(
	...
	dest, amt, fee, memo string) (*txnbuild.Transaction, error) {
